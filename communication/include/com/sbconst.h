...
/** Used to set the debug flags */
#define SB_MSGID_SET_DEBUG  0x19u

/** Repeat a message from one comm channel to the other */
#define SB_MSGID_REPEAT  0x1Au
...
/** Debug flags */
#define SB_DEBUG_ZERO_PROPELLER 0x01
